...
face_width_point = [94, 324]
face_height_point = [11, 153]
...
face_vt_distance = faceLine_dict['11'][1]-faceLine_dict['153'][1]
...
def 눈썹():
    ...
    # 굵음 vs 얇음 - Y 값 계산
    # 왼쪽 굵기
    eyebrow_vt_subtraction_left_left = (eyebrow_left_top_dict['64'][1] -
                                        eyebrow_left_btm_dict['54'][1]) / face_vt_distance
    eyebrow_vt_subtraction_left_middle = (eyebrow_left_top_dict['106'][1] -
                                          eyebrow_left_btm_dict['53'][1]) / face_vt_distance
    eyebrow_vt_subtraction_left_right = (eyebrow_left_top_dict['67'][1] -
                                         eyebrow_left_btm_dict['66'][1]) / face_vt_distance
    ...
    # ------------------------
    # 오른쪽 굵기
    eyebrow_vt_subtraction_right_left = (eyebrow_right_top_dict['297'][1] -
                                         eyebrow_right_btm_dict['296'][1]) / face_hr_distance
    eyebrow_vt_subtraction_right_middle = (eyebrow_right_top_dict['335'][1] -
                                           eyebrow_right_btm_dict['283'][1]) / face_hr_distance
    eyebrow_vt_subtraction_right_right = (eyebrow_right_top_dict['294'][1] -
                                          eyebrow_right_btm_dict['284'][1]) / face_hr_distance
...
path = 'C:/Users/master15/Desktop/0818Resnet/data/'   # 폴더 경로
        ...
        for face in results.multi_face_landmarks:
            for (i, landmark) in enumerate(face.landmark):
                ...
                if num in Eyeline_l:
                    ...
                    Face_area_dict[f'{num}'] = relative_x, relative_y
...
df_list = [df_eyebrow_desc, df_eye_desc,
           df_nose_desc, df_mouth_desc, df_faceLine_desc]
